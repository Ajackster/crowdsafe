/**
 * Created by ajackster on 2/8/16.
 */
...
app.controller("appController", ["$scope", "$location", "$routeParams", "globalReport", function($scope, $location, $routeParams, globalReport){
    ...
    $scope.imgMissing= [{name: "missing", imgage: "https://raw.githubusercontent.com/csc200/CrowdSafetyReport/master/CrowdSafetyAlerts/app/src/main/res/drawable/btn_missing.png"}];
    $scope.imgSanitary= [{name: "sanitary", imgage: "https://raw.githubusercontent.com/csc200/CrowdSafetyReport/master/CrowdSafetyAlerts/app/src/main/res/drawable/btn_sanitary.png"}];
    $scope.imgSuspicion= [{name: "suspicion", imgage: "https://raw.githubusercontent.com/csc200/CrowdSafetyReport/master/CrowdSafetyAlerts/app/src/main/res/drawable/btn_suspicion.png"}];

    $scope.imgMedical= [{name: "medical", imgage: "https://raw.githubusercontent.com/csc200/CrowdSafetyReport/master/CrowdSafetyAlerts/app/src/main/res/drawable/btn_medical.png"}];
    $scope.imgAgression = [{name: "agression", imgage: "https://raw.githubusercontent.com/csc200/CrowdSafetyReport/master/CrowdSafetyAlerts/app/src/main/res/drawable/btn_aggression.png"}];
    $scope.imgMap = [{name: "map", imgage: "https://raw.githubusercontent.com/csc200/CrowdSafetyReport/master/CrowdSafetyAlerts/app/src/main/res/drawable/btn_map.png"}];
    ...
    $scope.selectReportTypeMissing= function(index){
    ...
    $scope.selectReportTypeSanitary= function(index){
    ...
    $scope.selectReportTypeSuspicion= function(index){
    ...
    $scope.selectReportTypeMedical= function(index){
    ...
    $scope.selectReportTypeAgression= function(index){
    ...
    $scope.selectReportTypeMap= function(index){
